        ...
        <section id='work-process' className='relative z-10 pt-[110px]'>
          <div className='container'>
            <div
              ...
              <p className='text-base text-body text-white'>
          ...
          <div className='container max-w-[1390px]'>
            <div className='rounded-2xl bg-black text-white px-5 pt-14 pb-14 shadow-md md:pb-1 lg:pt-20 lg:pb-5 xl:px-10'>
              <div className='-mx-4 flex flex-wrap justify-center'>
                <div className='w-full px-4 md:w-1/2 lg:w-1/3'>
                  <div
                    className='wow fadeInUp group mx-auto mb-[60px] max-w-[310px] text-center'
                    data-wow-delay='.2s'>
                    <div className='mx-auto mb-8 flex h-[90px] w-[90px] items-center justify-center rounded-3xl bg-trblue  text-white'>
                      <svg
                        width='40'
                        height='40'
                        viewBox='0 0 40 40'
